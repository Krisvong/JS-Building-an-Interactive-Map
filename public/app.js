...
const rS = L.marker([48.866200610611926, 2.352236247419453],{icon: redPin}).bindPopup('RÃ©️aumur-SÃ©️bastopol')
...
const stations = L.layerGroup([rS, sSD, sentier, bourse, qS, gB],{icon: redPin}).addTo(myMap)
